...
const EditMaterial = ({ material, onClose, onUpdate }) => {
  ...
  const handleRemoveFile = () => {
    setFile(null);
    setFormData((prev) => ({ ...prev, fileType: material.fileType || "" }));
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.title || !formData.subject || !formData.fileType) {
    ...
    try {
      // In a real app, you would send the update to your backend here
      ...
      const updatedMaterial = {
        ...material,
        ...formData,
        fileName: file ? file.name : material.fileName,
        fileSize: file
            ...
            <div className="mb-6">
              ...
              {!file ? (
                <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-800">
                        {material?.fileName || "No file selected"}
                      </p>
                  ...
                  <div
                    className="flex items-center justify-center p-4 mt-3 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer hover:border-blue-500 hover:bg-blue-50"
